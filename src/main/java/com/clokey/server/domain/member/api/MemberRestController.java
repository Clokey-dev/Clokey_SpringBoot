...
public class MemberRestController {
    ...
    public BaseResponse<MemberDTO.GetFollowMemberResult> getFollowMembers(@PathVariable("clokeyId") String clokeyId,
                                                                          @RequestParam(value = "page", defaultValue = "1") Integer page,
                                                                          @RequestParam(value = "isFollowing", defaultValue = "true") Boolean isFollowing){
        MemberDTO.GetFollowMemberResult response = followingService.getFollowPeople(clokeyId, page, isFollowing);
        return BaseResponse.onSuccess(SuccessStatus.MEMBER_SUCCESS, response);
    }
}
