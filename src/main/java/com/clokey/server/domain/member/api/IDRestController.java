...
import com.clokey.server.domain.member.dto.IDResponseDTO;
import com.clokey.server.domain.member.application.IDQueryService;
...
@RequestMapping("users/{clokey_id}/check")
